...
## Módulos: import y export
  ...
  ### Export
  Para exportar una función, variable, etc. de un módulo, debemos colocar la palabra reservada export antes de la declaración de la misma:
  ```typescript
  ...
  ### Import
  Para importar una función, variable, etc. de un módulo, debemos colocar la palabra reservada import antes de la declaración de la misma:
  ```typescript
